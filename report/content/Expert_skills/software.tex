...
\nikolaj{The class diagram needs to agree with the development plan.\\
Current mismatches: \\
In development plan is ETA missing.\\
In ClassDiagram is UV flash missing.\\
Analyzer is called planning and Transformer and network is called generate program in devplan.\\
There is no guide on how to read this class diagram.\\
Oh and the figure is too small.
}
