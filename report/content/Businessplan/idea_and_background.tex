...
\node[minimum height=5cm,   minimum width=2.2cm,  text width=2cm, draw, name=KP] at (0,0)                  {\tiny\textbf{Key Partners:}}; 
\node[minimum height=2.5cm, minimum width=2.2cm,  text width=2cm, draw, name=KA,xshift=1.15cm] at(KP.45)   {\tiny\textbf{Key Activities:}};
\node[minimum height=2.5cm, minimum width=2.2cm,  text width=2cm, draw, name=KR,below of=KA]               {\tiny\textbf{Key Resources:}}; 
\node[minimum height=5cm,   minimum width=2.2cm,  text width=2cm, draw, name=VP,right of=KA]               {\tiny\textbf{Value Proposition:}};
\node[minimum height=2.5cm, minimum width=2.2cm,  text width=2cm, draw, name=CR,right of=VP]               {\tiny\textbf{Customer Relationship:}}; 
\node[minimum height=2.5cm, minimum width=2.2cm,  text width=2cm, draw, name=Ch,below of=CR]               {\tiny\textbf{Channels:}};
\node[minimum height=5cm,   minimum width=2.2cm,  text width=2cm, draw, name=CuS,right of=CR]              {\tiny\textbf{Customer Segments:}};
\node[minimum height=2cm,   minimum width=6.25cm, text width=2cm, draw, name=CoS,yshift=-1.1cm] at(KP.270) {\tiny\textbf{Cost Structure:}}; 
\node[minimum height=2cm,   minimum width=6.25cm, text width=2cm, draw, name=RS,right of=CoS,xshift=4cm]              {\tiny\textbf{Revenue Streams:}}; 
\end{tikzpicture}
