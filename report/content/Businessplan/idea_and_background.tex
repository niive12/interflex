...
\node[minimum height=2.5cm, minimum width 2.2cm, text width=2cm, draw, name=KA,right of=KP] {\tiny\textbf{Key Activities:}};
\node[minimum height=2.5cm, minimum width 2.2cm, text width=2cm, draw, name=KR,below of=KA] {\tiny\textbf{Key Resources:}}; 
\node[minimum height=5cm, minimum width 2.2cm, text width=2cm, draw, name=VA,right of=KA] {\tiny\textbf{Value Proposition:}};
...
\node[minimum height=5cm, minimum width 2.2cm, text width=2cm, draw, name=CuS,right of=KP] {\tiny\textbf{Customer Segments:}};
\node[minimum height=2cm, minimum width 6.25cm, text width=2cm, draw, name=CoS,below of=KP] {\tiny\textbf{Cost Structure:}}; 
\node[minimum height=2cm, minimum width 6.25cm, text width=2cm, draw, name=RS,right of=CoS] {\tiny\textbf{Revenue Streams:}}; 
\end{tikzpicture}
